    ...
    <header className="bg-white shadow-md fixed w-full z-10">
      <div className="container mx-auto px-6  flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <Link href="/" className={`${pathName == '/' ? 'text-gray-950 border-b-2' : 'text-gray-700'} hover:text-gray-900`}>
            Home
          </Link>
          <Link href="/product" className={`${pathName == '/product' ? 'text-gray-950 border-b-2' : 'text-gray-700'} hover:text-gray-900`}>
            Product
          </Link>
          <Link href="/contactus" className={`${pathName == '/contactus' ? 'text-gray-950 border-b-2' : 'text-gray-700'} hover:text-gray-900`}>
            Contact Us
          </Link>
        </nav>
